...
//#define SERVO3_PIN         10 // used for filament runout sensor
#define FIL_RUNOUT_PIN                      10  // JP3, Tfeed2
...
#define Z_STEP_PIN         42 //right Z
#define Z_DIR_PIN          43
#define Z_ENABLE_PIN       40

#define Z2_STEP_PIN        41 //left Z
...
//joris 2020-06-22 temp swapped to test led on mainboard
...
#define SUICIDE_PIN         11 //was 54,  PIN that has to be turned on right after start, to keep power flowing.
